# Creates the Cypress objects for the Python-companion variant of the swift_map_batching
# scenario, under its own root ($YT_DEV_ROOT/swift_map_batching_py) so the C++ variant's
# objects stay inspectable. Same objects as ../yt_sync.py: the pipeline node, the five-tablet
# input queue with its consumer, and the output queue.
#
...
FOLDER = os.environ["YT_DEV_ROOT"] + "/swift_map_batching_py"

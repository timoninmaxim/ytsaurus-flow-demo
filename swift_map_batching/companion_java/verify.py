# Verifies the Java-companion variant with the same asserts as the reference README's
# verification snippet (and the upstream test), against the swift_map_batching_java root:

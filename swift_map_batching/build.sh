...
# swift_map_batching_companion.stripped — that stripped file is what run.sh ships into the worker's
...
STAGE_DIR="$YTSAURUS/yt/yt/flow/demo/swift_map_batching"
...
(cd "$YTSAURUS" && ./ya make --build=release yt/yt/flow/demo/swift_map_batching)

strip -o swift_map_batching_companion.stripped "$STAGE_DIR/swift_map_batching_companion"
chmod +x swift_map_batching_companion.stripped

ls -l swift_map_batching_companion.stripped

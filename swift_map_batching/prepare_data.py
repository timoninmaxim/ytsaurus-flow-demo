# Writes one wave of events into the input queue: event_id from <start> to <start + count>,
# group_key = event_id % 10 (ten grouping keys, as upstream), spread over the queue's five
# tablets by event_id % 5.
#
...
def main():
    ...
    queue = f"{os.environ['YT_DEV_ROOT']}/swift_map_batching/input_queue"

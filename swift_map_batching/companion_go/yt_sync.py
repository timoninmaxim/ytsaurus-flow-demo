# Creates the Cypress objects for the Go-companion variant of the swift_map_batching
# scenario, under its own root ($YT_DEV_ROOT/swift_map_batching_go) so the C++ and Python

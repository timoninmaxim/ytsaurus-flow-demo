# Creates the Cypress objects for the secret_env scenario: just the pipeline
# node — the pipeline has no queues or state tables of its own.
#
...
FOLDER = os.environ["YT_DEV_ROOT"] + "/secret_env"

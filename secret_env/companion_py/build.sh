#!/usr/bin/env bash
# Builds companion_bundle.tgz -- everything the Python secret checker needs at runtime inside
...
#   - main.py (the secret checker).
# Same recipe as state_joiner/companion_py/build.sh: the ytsaurus-flow-companion wheel is taken

# Creates the Cypress objects for the Python-companion variant of the secret_env scenario,
# under its own root ($YT_DEV_ROOT/secret_env_py) so the C++ variant's objects stay
# inspectable: the pipeline node, the input queue with its consumer, and the output queue the
# checker reports its observations into.
#
...
FOLDER = os.environ["YT_DEV_ROOT"] + "/secret_env_py"

# Creates the Cypress objects for the Java-companion variant of the secret_env scenario,
# under its own root ($YT_DEV_ROOT/secret_env_java) so the other variants' objects
...
FOLDER = os.environ["YT_DEV_ROOT"] + "/secret_env_java"

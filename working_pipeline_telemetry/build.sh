...
# dir as working_pipeline_telemetry_pipeline.stripped — that stripped file is what run.sh deploys.
#
...
STAGE_DIR="$YTSAURUS/yt/yt/flow/demo/working_pipeline_telemetry"
...
(cd "$YTSAURUS" && ./ya make --build=release yt/yt/flow/demo/working_pipeline_telemetry)

strip -o working_pipeline_telemetry_pipeline.stripped "$STAGE_DIR/working_pipeline_telemetry_pipeline"
chmod +x working_pipeline_telemetry_pipeline.stripped

ls -l working_pipeline_telemetry_pipeline.stripped

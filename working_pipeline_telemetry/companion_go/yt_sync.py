...
# ($YT_DEV_ROOT/working_pipeline_telemetry_go) so the C++ variant's objects stay
...
FOLDER = os.environ["YT_DEV_ROOT"] + "/working_pipeline_telemetry_go"

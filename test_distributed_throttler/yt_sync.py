# Creates the Cypress objects for the test_distributed_throttler scenario: the
# pipeline node, the input queue with its consumer, and the output queue.
#
...
FOLDER = os.environ["YT_DEV_ROOT"] + "/test_distributed_throttler"

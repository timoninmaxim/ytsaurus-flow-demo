# Verifies the key-visitor sweep against the upstream test's asserts (tests/key_visitor/cpp,
# Test.test_key_visitor):
...
#
# Run after sourcing your env file, once ./run.sh has been started:
#   python3 verify.py

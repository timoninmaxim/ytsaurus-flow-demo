# Creates the Cypress objects for the Java-companion variant of the key_visitor scenario,
# under its own root ($YT_DEV_ROOT/key_visitor_java) so the C++ variant's objects stay

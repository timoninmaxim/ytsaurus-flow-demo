# Creates the Cypress objects for the Go-companion variant of the key_visitor scenario,
# under its own root ($YT_DEV_ROOT/key_visitor_go) so the C++ variant's objects stay
...
FOLDER = os.environ["YT_DEV_ROOT"] + "/key_visitor_go"

# Creates the Cypress objects for the key_visitor scenario: the pipeline node (its preset
# includes the engine's key_visitor_states table the visitor sweeps from), the input queue with
# its consumer, and the output queue the visit rows land in.
#
...
FOLDER = os.environ["YT_DEV_ROOT"] + "/key_visitor"

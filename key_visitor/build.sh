...
# dir as key_visitor_pipeline.stripped — that stripped file is what run.sh deploys.
#
...
STAGE_DIR="$YTSAURUS/yt/yt/flow/demo/key_visitor"
...
(cd "$YTSAURUS" && ./ya make --build=release yt/yt/flow/demo/key_visitor)

strip -o key_visitor_pipeline.stripped "$STAGE_DIR/key_visitor_pipeline"
chmod +x key_visitor_pipeline.stripped

ls -l key_visitor_pipeline.stripped

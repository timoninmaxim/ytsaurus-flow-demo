# Creates the Cypress objects for the Python-companion variant of the state_joiner scenario,
# under its own root ($YT_DEV_ROOT/state_joiner_py) so the C++ variant's objects stay
...
FOLDER = os.environ["YT_DEV_ROOT"] + "/state_joiner_py"

# Creates the Cypress objects for the state_joiner scenario: the pipeline node, the input queue
# with its consumer, the user_totals table the accumulator keeps its per-user totals in, and the
...
FOLDER = os.environ["YT_DEV_ROOT"] + "/state_joiner"

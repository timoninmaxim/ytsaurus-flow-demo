...
# dir as transform_high_throughput_pipeline.stripped — that stripped file is what run.sh deploys.
#
...
STAGE_DIR="$YTSAURUS/yt/yt/flow/demo/transform_high_throughput"
...
(cd "$YTSAURUS" && ./ya make --build=release yt/yt/flow/demo/transform_high_throughput)

strip -o transform_high_throughput_pipeline.stripped "$STAGE_DIR/transform_high_throughput_pipeline"
chmod +x transform_high_throughput_pipeline.stripped

ls -l transform_high_throughput_pipeline.stripped

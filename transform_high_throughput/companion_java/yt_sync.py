...
# ($YT_DEV_ROOT/transform_high_throughput_java) so the C++, Python and Go variants' objects stay
...
#   python3 companion_java/yt_sync.py
...
FOLDER = os.environ["YT_DEV_ROOT"] + "/transform_high_throughput_java"
...
def main():
    ...
    run_yt_sync_easy_mode(
        "transform_high_throughput_java",
        StagesSpec(
            stages=stages,
            pipelines=pipelines,
            tables=tables,

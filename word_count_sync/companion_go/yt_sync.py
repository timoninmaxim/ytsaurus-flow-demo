# Creates the Cypress objects for the Go-companion variant of the word_count_sync scenario,
# under its own root ($YT_DEV_ROOT/word_count_sync_go) so the C++ variant's objects stay
...
FOLDER = os.environ["YT_DEV_ROOT"] + "/word_count_sync_go"

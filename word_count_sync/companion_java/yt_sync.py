# Creates the Cypress objects for the Java-companion variant of the word_count_sync scenario,
# under its own root ($YT_DEV_ROOT/word_count_sync_java) so the C++ variant's objects stay
# inspectable. Same objects as ../yt_sync.py: the pipeline node, the input queue with its
# consumer, the word_counts external-state table and the skipped_words table.
#
...
FOLDER = os.environ["YT_DEV_ROOT"] + "/word_count_sync_java"

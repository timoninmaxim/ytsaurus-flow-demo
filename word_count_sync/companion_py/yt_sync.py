# Creates the Cypress objects for the Python-companion variant of the word_count_sync scenario,
# under its own root ($YT_DEV_ROOT/word_count_sync_py) so the C++ variant's objects stay
...
FOLDER = os.environ["YT_DEV_ROOT"] + "/word_count_sync_py"

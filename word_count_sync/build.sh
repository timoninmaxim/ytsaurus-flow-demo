...
# word_count_sync_companion.stripped — that stripped file is what run.sh ships into the worker's
...
STAGE_DIR="$YTSAURUS/yt/yt/flow/demo/word_count_sync"
...
(cd "$YTSAURUS" && ./ya make --build=release yt/yt/flow/demo/word_count_sync)

strip -o word_count_sync_companion.stripped "$STAGE_DIR/word_count_sync_companion"
chmod +x word_count_sync_companion.stripped

ls -l word_count_sync_companion.stripped

...
# computation_cycles_companion.stripped — that stripped file is what run.sh ships into the worker's
...
STAGE_DIR="$YTSAURUS/yt/yt/flow/demo/computation_cycles_and_buffers"
...
(cd "$YTSAURUS" && ./ya make --build=release yt/yt/flow/demo/computation_cycles_and_buffers)

strip -o computation_cycles_companion.stripped "$STAGE_DIR/computation_cycles_companion"
chmod +x computation_cycles_companion.stripped

ls -l computation_cycles_companion.stripped

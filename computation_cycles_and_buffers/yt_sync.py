# Creates the Cypress objects for the computation_cycles_and_buffers scenario: the pipeline node,
# the input queue with its consumer, and the state table the reducer keeps its counts in.
#
...
FOLDER = os.environ["YT_DEV_ROOT"] + "/computation_cycles_and_buffers"

# Creates the Cypress objects for the Go-companion variant of the computation_cycles_and_buffers
# scenario, under its own root ($YT_DEV_ROOT/computation_cycles_go) so the C++ variant's objects
...
FOLDER = os.environ["YT_DEV_ROOT"] + "/computation_cycles_go"
